...
/*===| 底盘相关参数定义 |===*/
    ...
    #define Robo_Wz_MaxSpeed                    14.0f     //机器最大Z角速度
        
    #define Chassis_Acc                         12.0f     //底盘加速度
    #define Chassis_Dec                         50.0f     //底盘加速度    
    
    #define Chassis_Dash_Speed_Multiple         1.5f     //冲刺模式后轮速度倍率
   
        
/*===| 云台相关参数定义 |===*/  
    #define Gimbal_Median_Yaw                  (87.5321503f-180.0F)      //云台朝前时Yaw电机的编码值
    #define Gimbal_Median_Pitch                 0        //云台水平时Pitch电机的角度

    #define Gimbal_Pitch_Limit_Up               5.0f//陀螺仪限位
    #define Gimbal_Pitch_Limit_Down             -33.0f
    
    #define PI_to_Degree                        (180.0f/PI)
    #define Degree_to_PI                       (PI/180.0f)
/*===| 发射相关参数定义 |===*/
    #define Fric_Acc 10.0f
...
/*===| 调试相关定义 |===*/
#define VOFA_UART &huart4                    //vofa调试使用的串口
#define VOFA_TXDATA_SIZE 14                    //vofa调试发送的信息量（float）
#define VOFA_RXDATA_SIZE 5
